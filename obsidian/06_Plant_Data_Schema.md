...
## 5. Growth timing & stage scaling
* `days_to_mature` / `days_to_senescence` — drive the 6 visual/biology stages (see [[26_Six_Stage_Growth_and_Dynamic_Exchange]]).
* Baseline `*_delta` columns are multiplied at runtime by stage; UI forecasts use the scaled values.